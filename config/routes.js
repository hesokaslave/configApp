...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'get /config/:uuid/:env' : 'ConfigController.findOne',
  'get /config' : 'ConfigController.findAll',
  'post /config' : 'ConfigController.create',
  'patch /config/:uuid/:env' : 'ConfigController.update',
  'delete /config/:uuid/:env' : 'ConfigController.delete',

  'get /message' : 'MessageController.findAll',
